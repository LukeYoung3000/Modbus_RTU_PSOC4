...
#include "RS485_EN.h"
    ...
    #define RS485_EN_SetP4PinDriveMode(shift, mode)  \
    do { \
        RS485_EN_PC =   (RS485_EN_PC & \
                                (uint32)(~(uint32)(RS485_EN_DRIVE_MODE_IND_MASK << \
                                (RS485_EN_DRIVE_MODE_BITS * (shift))))) | \
                                (uint32)((uint32)(mode) << \
                                (RS485_EN_DRIVE_MODE_BITS * (shift))); \
    } while (0)
#else
        ...
        #define RS485_EN_SetP4PinDriveMode(shift, mode)  \
        do { \
            RS485_EN_USBIO_CTRL_REG = (RS485_EN_USBIO_CTRL_REG & \
                                    (uint32)(~(uint32)(RS485_EN_DRIVE_MODE_IND_MASK << \
                                    (RS485_EN_DRIVE_MODE_BITS * (shift))))) | \
                                    (uint32)((uint32)(mode) << \
                                    (RS485_EN_DRIVE_MODE_BITS * (shift))); \
    ...
    *******************************************************************************/
    ...
    {
		RS485_EN_SetP4PinDriveMode(RS485_EN__0__SHIFT, mode);
    }
#endif
...
{
    uint8 drVal = (uint8)(RS485_EN_DR & (uint8)(~RS485_EN_MASK));
    drVal = (drVal | ((uint8)(value << RS485_EN_SHIFT) & RS485_EN_MASK));
    RS485_EN_DR = (uint32)drVal;
}
...
{
    return (uint8)((RS485_EN_PS & RS485_EN_MASK) >> RS485_EN_SHIFT);
}
...
{
    return (uint8)((RS485_EN_DR & RS485_EN_MASK) >> RS485_EN_SHIFT);
}
...
void RS485_EN_SetInterruptMode(uint16 position, uint16 mode)
{
    ...
    intrCfg =  RS485_EN_INTCFG & (uint32)(~(uint32)position);
    RS485_EN_INTCFG = intrCfg | ((uint32)position & (uint32)mode);
}
...
{
	uint8 maskedStatus = (uint8)(RS485_EN_INTSTAT & RS485_EN_MASK);
	RS485_EN_INTSTAT = maskedStatus;
    return maskedStatus >> RS485_EN_SHIFT;
}
