// ======================================================================
// Basic_1_Modbus_RTU_PSOC4.v generated from TopDesign.cysch
// 02/04/2020 at 11:54
...
module top ;
	...
	wire [0:0] tmpOE__RS485_EN_2_net;
	wire [0:0] tmpFB_0__RS485_EN_2_net;
	wire [0:0] tmpIO_0__RS485_EN_2_net;
	wire [0:0] tmpINTERRUPT_0__RS485_EN_2_net;
	electrical [0:0] tmpSIOVREF__RS485_EN_2_net;

	cy_psoc3_pins_v1_10
		#(.id("26dcd95c-e5fe-4e52-a782-0eacf33ec799"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		RS485_EN_2
		 (.oe(tmpOE__RS485_EN_2_net),
		  .y({Net_2409}),
		  .fb({tmpFB_0__RS485_EN_2_net[0:0]}),
		  .io({tmpIO_0__RS485_EN_2_net[0:0]}),
		  .siovref(tmpSIOVREF__RS485_EN_2_net),
		  .interrupt({tmpINTERRUPT_0__RS485_EN_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RS485_EN_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("bd37bc84-053c-4faf-a000-dddcf25135ac"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a2b1a7d8-f917-4a46-aac4-f0a02dfeb539"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    UART_v2_50_2 RS485 (
        ...
        .reset(1'b0),
        .rx(Net_2367),
        .tx_interrupt(Net_2412),
        .rx_interrupt(Net_3536),
        .tx_data(Net_2413),
        .tx_clk(Net_2414),
        .rx_data(Net_2415),
        .rx_clk(Net_2416));
	...
	cy_clock_v1_0
		#(.id("11701664-3fd0-4d61-9ec0-2727194c4590"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__RS485_EN_1_net;
	wire [0:0] tmpFB_0__RS485_EN_1_net;
	wire [0:0] tmpIO_0__RS485_EN_1_net;
	wire [0:0] tmpINTERRUPT_0__RS485_EN_1_net;
	electrical [0:0] tmpSIOVREF__RS485_EN_1_net;

	cy_psoc3_pins_v1_10
		#(.id("71874afc-3f82-43cb-af71-ebb6fdbe6646"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		RS485_EN_1
		 (.oe(tmpOE__RS485_EN_1_net),
		  .y({Net_2409}),
		  .fb({tmpFB_0__RS485_EN_1_net[0:0]}),
		  .io({tmpIO_0__RS485_EN_1_net[0:0]}),
		  .siovref(tmpSIOVREF__RS485_EN_1_net),
		  .interrupt({tmpINTERRUPT_0__RS485_EN_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RS485_EN_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
